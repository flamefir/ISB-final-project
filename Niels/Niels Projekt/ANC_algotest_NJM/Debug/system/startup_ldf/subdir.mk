...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="ANC_algotest_NJM" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-bc30f6f6ba418e5df7d64cbc950392e7.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

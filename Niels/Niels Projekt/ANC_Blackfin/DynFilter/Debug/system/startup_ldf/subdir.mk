...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="ANC" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-236bd6a972d66cd4029b42ca0f6d614c.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

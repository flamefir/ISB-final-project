...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="DSPFramework" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-a79f72a49d19e2e6fef6a615d818bf3d.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

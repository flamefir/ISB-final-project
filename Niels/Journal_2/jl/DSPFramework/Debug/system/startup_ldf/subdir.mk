...
system/startup_ldf/app_cplbtab.doj: ../system/startup_ldf/app_cplbtab.c
	...
	ccblkfn -c -file-attr ProjectName="DSPFramework" -proc ADSP-BF533 -flags-compiler --no_wrap_diagnostics -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-370c58a469c903a54fb4272d79e285a8.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -decls-strong -cplbs -gnu-style-dependencies -MD -Mo "system/startup_ldf/app_cplbtab.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="DSPFramework" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-59ff76fd401a4bb17343e5571ec773d7.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

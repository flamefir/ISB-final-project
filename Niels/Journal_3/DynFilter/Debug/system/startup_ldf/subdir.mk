...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="DynFilter" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-57903914d84586a2810b6ee4fdbe17e0.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

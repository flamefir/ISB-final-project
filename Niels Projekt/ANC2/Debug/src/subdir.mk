...
src/AlgoTester.doj: ../src/AlgoTester.cpp
	...
	ccblkfn -c -file-attr ProjectName="ANC2" -proc ADSP-BF533 -flags-compiler --no_wrap_diagnostics -si-revision 0.6 -O -Ov100 -g -DCORE0 -D_DEBUG @includes-05d051cca1a1b0d60d7d959995802c42.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -decls-strong -cplbs -gnu-style-dependencies -MD -Mo "src/AlgoTester.d" -c++ -o "$@" "$<"

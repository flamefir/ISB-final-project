...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="ANC2" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-a5f0f54a42c9dd8cb2f247ccc311dc77.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn.exe -file-attr ProjectName="DSPFramework" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG -i"C:\Users\au288681\Dropbox\ETISB\codeExamples\DSPFramework\system" -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
